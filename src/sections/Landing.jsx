      ...
      <div className="z-30 basis-3/6 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-5 mb-7 text-lg text-center md:text-start">
            ...
            />{" "}
            creating responsive, user-friendly websites that blend creativity
            and technical expertise, reflecting Moroccan culture while embracing
        ...
        >
          <AnchorLink
            className="bg-white/30 backdrop-blur-md rounded-sm py-3 px-7 font-semibold transition duration-500 me-1 hover:bg-white/50 hover:bg-opacity-80 hover:backdrop-blur-lg"
          ...
          <AnchorLink
            className="flex items-center gap-2 bg-lime-600 backdrop-blur-md rounded-sm py-3 px-7 font-semibold
            transition duration-500 ms-1 hover:bg-lime-400 hover:bg-opacity-80 hover:backdrop-blur-lg"
